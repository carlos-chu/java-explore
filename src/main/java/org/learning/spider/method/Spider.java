package org.learning.spider.method;
...
import org.learning.spider.bean.ZhiHuBean;
import org.learning.spider.bean.ZhiHuPicBean;
import org.learning.spider.bean.ZhiHuUserBean;
...
public class Spider {
    ...
    public static void getTopUserInfo(String url) throws Exception {
        ...
        /**
         * jdbc四大配置参数： 1.driverClassName:com.mysql.jdbc.Driver 2.url:jdbc:mysql://localhost:3306/mydb 3.username:root
         * 4.password:123
         */
        ...
        /*
         * 对数据库做增、删、改 1.通过Connection对象创建Statement Statement语句的发送器，它的功能就是向数据库发送sql语句！ 2.调用他的int executeUpdate(String
         * sql),返回影响了几行
         */
